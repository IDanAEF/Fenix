                            ...
                            if (typeof $cRow.data('format') !== 'undefined') {
                                if ($cRow.data('format') == '1') {
                                    ...
                                    if (moment($cRow.text(), tableOptions.date_format).format($cRow.data('format')) === 'Invalid date') {
                                        $cRow.text(moment($cRow.text(), $cRow.data('format')).format($cRow.data('format')));
                                    } else {
                                        $cRow.text(moment($cRow.text(), tableOptions.date_format).format($cRow.data('format')));
                                    }
                                }
                            }
                            ...
                            if (typeof data.format_date_cell !== 'undefined' && typeof data.format_date_cell[key] !== 'undefined') {
                                if (data.format_date_cell[key] === '1') {
                                    ...
                                    if (moment($cRow.text(), tableOptions.date_format).format(data.format_date_cell[key]) === 'Invalid date') {
                                        $cRow.text(moment($cRow.text(), data.format_date_cell[key]).format(data.format_date_cell[key]));
                                    } else {
                                        $cRow.text(moment($cRow.text(), tableOptions.date_format).format(data.format_date_cell[key]));
                                    }
                                }
                            }
                        }
